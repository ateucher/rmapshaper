...
test_that("ms_innerlines works with all classes", {
  expected_json <- structure("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":0},\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[103,3],[103,2]]}},\n{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":1},\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[103,2],[102,2]]}},\n{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":2},\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[104,2],[103,2]]}},\n{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":3},\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[103,2],[103,1]]}}]}", class = c("json", "geo_json"))
