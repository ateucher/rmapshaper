...
line <- structure("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":0},\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[-145.823797406629,38.9089996693656],[-126.677279351279,-31.5765906963497],[55.2621808089316,-50.0359470024705],[-71.0863546840847,-63.6745454510674],[-85.5087857600302,-39.2010589549318],[61.3280264195055,-21.5475816093385],[111.265920912847,-12.028357652016],[86.1034004017711,-16.9480841606855],[44.9973328784108,70.142569988966],[-31.4937972743064,14.8874527355656],[26.4844715315849,31.5380143700168],[-58.8240995630622,56.9820305798203],[-63.5386520437896,60.1704036584124],[-108.767749238759,5.83010089583695],[78.9820377342403,53.8167471718043],[110.499991988763,82.2511944221333],[-177.570751542225,55.7854177616537],[-16.1148327123374,25.1785923494026],[117.501273332164,-53.2969523733482],[168.682718127966,2.06833674106747]]}}]}", class = c("json",
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   "geo_json"))
...
test_that("ms_simplify.geo_json works with defaults", {
  ...
  expect_equal(default_simplify_json, structure("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":0},\"geometry\":{\"type\":\"Polygon\",\"coordinates\":[[[52.8658,-44.7219],[53.7702,-40.4873],[61.0835,-40.7529],[58.0202,-43.634],[62.737,-46.2841],[55.7763,-46.2637],[52.8658,-44.7219]]]}}]}", class = c("json", "geo_json")))
...
test_that("ms_simplify.geo_json works with different methods", {
  ...
  expect_equal(vis_simplify_json, structure("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":0},\"geometry\":{\"type\":\"Polygon\",\"coordinates\":[[[52.8658,-44.7219],[62.737,-46.2841],[52.799,-45.9386],[50.0123,-54.9834],[49.0098,-52.3641],[52.8658,-44.7219]]]}}]}", class = c("json", "geo_json")))
  expect_is(dp_simplify_json, "geo_json")
  expect_equal(dp_simplify_json, structure("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":0},\"geometry\":{\"type\":\"Polygon\",\"coordinates\":[[[52.8658,-44.7219],[55.3204,-37.5579],[53.0884,-45.7021],[62.737,-46.2841],[52.799,-45.9386],[54.385,-55.3905],[46.7767,-38.3542],[52.8658,-44.7219]]]}}]}", class = c("json", "geo_json")))
})
...
test_that("ms_simplify works with lines", {
  expected_json <- structure("{\"type\":\"FeatureCollection\",\"features\":[{\"type\":\"Feature\",\"properties\":{\"rmapshaperid\":0},\"geometry\":{\"type\":\"LineString\",\"coordinates\":[[-145.823797406629,38.9089996693656],[168.682718127966,2.06833674106747]]}}]}", class = c("json",
                                                                                                                                                                                                                                                                                       "geo_json"))
