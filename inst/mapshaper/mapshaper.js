// from https://github.com/mbloch/mapshaper/blob/master/mapshaper.js
(function(){
...
MapShaper.processFileContent = function(tokens, content, done) {
  ...
  try {
    ...
    if (content) {
      ...
      //ACT: try using importGeoJSON directly??
      //dataset = MapShaper.importGeoJSON(content, inOpts);
    }
